...
public class PresaleResponse {
    ...
    public PresaleResponse(String id, String payment, String otr, String down_payment, String discount, String leasing, String installment, String tenor, String program, int presales_no, int vehicle_id, int customer_id, String status, List<Presale> data) {
        this.id = id;
    ...
    public List<Presale> getData() {
        return data;
    }

    public void setData(List<Presale> data) {
        this.data = data;
    }
}
